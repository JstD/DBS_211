...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch(`${server}/api/teacher/auth`, {
            method: 'POST',
            headers: {
        ...
        <Log>
            <Container>
                <Box>
                    ...
                    <h2>Not have a teacher account? <h3><Link to="/" style={{ color: "#3B49DF", textDecoration: "none" }}> View as anonymous</Link></h3>
                    </h2>
                </Box>
            </Container>
        </Log>
